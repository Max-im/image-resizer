  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-[99] w-full overflow-hidden">
      <div className="container-xl mx-auto flex justify-between items-center py-4 px-6">
        ...
        <div>
          <a href="https://max-im.github.io/media-compressor/media-compressor-0.3.1" className="bg-black hover:bg-gray-700 animate-pulse text-white px-4 py-2 mr-12 rounded-md " download>Download</a>
