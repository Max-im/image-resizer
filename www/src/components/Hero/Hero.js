        ...
        <div className={styles.inner}>
          <div className={`${styles.box} bg-accent-blue px-4 md:px-8 py-10 md:py-12 rounded-xl`}>
            ...
            <div className="flex space-x-2 md:space-x-4">
              <a href="https://max-im.github.io/media-compressor/mediaCompressor.zip" download className="bg-black hover:bg-gray-700 text-white px-3 md:px-6 py-2 md:py-3 rounded-md text-lg">Download for Free</a>
